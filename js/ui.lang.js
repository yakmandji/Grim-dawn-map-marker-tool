...
(function () {
  ...
  const translations = {
    en: {
      ...
      "ui.Archive": "Archive",
      "ui.Done": "Done",
      "ui.ArchiveTitle": "The marker will remain accessible through search and the archive panel",
    ...
    fr: {
      ...
      "ui.Done": "Terminé",
      "ui.Archive": "Archiver",
      "ui.ArchiveTitle": "Le marqueur restera accessible depuis la recherche et le panneau des archives",
    ...
    es: {
      ...
      "ui.Done": "Hecho",
      "ui.Archive": "Archivar",
      "ui.ArchiveTitle": "El marcador seguirá siendo accesible desde la búsqueda y el panel de archivos",
    ...
    de: {
      ...
      "ui.ArchiveTitle": "Der Marker bleibt über die Suche und das Archivpanel zugänglich",
  ...
  pt: {
    ...
    "ui.Done": "Concluído",
    "ui.Archive": "Arquivar",
    "ui.ArchiveTitle": "O marcador continuará acessível pela pesquisa e pelo painel de arquivos",
  ...
  ru: {
    ...
    "ui.ArchiveTitle": "Маркер останется доступным через поиск и панель архива",
    ...
    it: {
      ...
      "ui.Done": "Completato",
      "ui.Archive": "Archivia",
      "ui.ArchiveTitle": "Il marcatore rimarrà accessibile tramite la ricerca e il pannello degli archivi",
    ...
    pl: {
      ...
      "ui.ArchiveTitle": "Znacznik pozostanie dostępny poprzez wyszukiwanie oraz panel archiwum",
    ...
    zh: {
      ...
      "ui.Done": "已完成",
      "ui.Archive": "归档",
      "ui.ArchiveTitle": "该标记仍可通过搜索和归档面板访问",
    ...
    ja: {
      ...
      "ui.Done": "完了",
      "ui.Archive": "アーカイブ",
      "ui.ArchiveTitle": "このマーカーは検索およびアーカイブパネルから引き続き利用できます",
