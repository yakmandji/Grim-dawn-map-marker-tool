...
(function () {
  ...
  const translations = {
    en: {
      ...
      "ui.HelpLineNote2": "Region notes cannot be shared when generating a shared link",
      "ui.Routes": "Routes",
      ...
      "ui.Share": "Share",
      "ui.HelpLineShare1": "Click Share Map to generate a shared link with your routes and shared markers",
    ...
    fr: {
     ...
     'ui.MergeRoutesButton': 'Ajouter le partage à ma carte',
      ...
      "ui.HelpLineNote2": "Les notes de région ne sont jamais partagées lors de la génération d’un lien",
      "ui.Routes": "Tracés",
      ...
      "ui.Share": "Partage",
      "ui.HelpLineShare1": "Cliquez sur « Partager ma carte » pour générer un lien contenant vos tracés et vos marqueurs partagés",
    ...
    es: {
      ...
      "ui.HelpLineNote2": "Las notas de región no se comparten al generar un enlace",
      "ui.Routes": "Rutas",
      ...
      "ui.Share": "Compartir",
      "ui.HelpLineShare1": "Haz clic en Compartir mapa para generar un enlace con tus rutas y marcadores compartidos",
    ...
    de: {
      ...
      "ui.HelpLineNote2": "Regionsnotizen werden beim Erstellen eines Freigabelinks nicht geteilt",
      "ui.Routes": "Routen",
      ...
      "ui.Share": "Teilen",
      "ui.HelpLineShare1": "Klicken Sie auf Karte teilen, um einen Link mit Ihren Routen und geteilten Markern zu erzeugen",
  ...
  pt: {
    ...
    'ui.MergeRoutesButton': 'Adicionar compartilhado ao meu mapa',
     ...
     "character.CreateButton": "Criar",
      ...
      "ui.HelpLineNote2": "Notas de região não são compartilhadas ao gerar o link",
      "ui.Routes": "Rotas",
      ...
      "ui.HelpLineShare1": "Clique em Compartilhar mapa para gerar um link com suas rotas e marcadores compartilhados",
  ...
  ru: {
    ...
    "ui.HelpLineNote2": "Заметки о регионах не передаются при создании ссылки",
    "ui.Routes": "Маршруты",
    ...
    "ui.Share": "Поделиться",
    "ui.HelpLineShare1": "Нажмите Поделиться картой, чтобы создать ссылку с маршрутами и общими маркерами",
    ...
    it: {
      ...
      "ui.HelpLineNote2": "Le note di regione non vengono condivise quando generi un link",
      "ui.Routes": "Percorsi",
      ...
      "ui.Share": "Condividi",
      "ui.HelpLineShare1": "Clicca Condividi mappa per generare un link con percorsi e segnalini condivisi",
    ...
    zh: {
      ...
      "ui.HelpLineNote2": "区域备注不会包含在共享链接中",
      "ui.Routes": "路线",
      ...
      "ui.Share": "分享",
      "ui.HelpLineShare1": "点击“分享地图”以生成包含路线和共享标记的链接",
    ...
    ja: {
      ...
      "ui.HelpLineNote2": "地域ノートは共有リンクには含まれません",
      "ui.Routes": "ルート",
      ...
      "ui.Share": "共有",
      "ui.HelpLineShare1": "「マップを共有」をクリックすると、ルートと共有マーカーを含むリンクが生成されます",
