...
(function () {
  ...
  const translations = {
    en: {
      ...
      "share.tooltip": "Share your map with your markers, routes, and notes. No account required.",
      ...
      "ui.HelpLineMarker2": "If you check the Shared box, the marker will be included when generating a shared link",
      "ui.Notes": "Notes",
    ...
    fr: {
     ...
     'ui.MergeRoutesButton': 'Ajouter le partage à ma carte',
      ...
      "share.tooltip": "Partager votre carte avec vos marqueurs, routes et notes. Aucun compte requis.",
      ...
      "ui.HelpLineMarker2": "Si vous cochez « Partagé », le marqueur sera inclus dans le lien de partage",
      "ui.Notes": "Notes",
    ...
    es: {
      ...
      "share.tooltip": "Comparte tu mapa con tus marcadores, rutas y notas. No se requiere cuenta.",
      ...
      "ui.HelpLineMarker2": "Si marcas la opción Compartido, el marcador se incluirá en el enlace compartido",
      "ui.Notes": "Notas",
    ...
    de: {
      ...
      "share.tooltip": "Teile deine Karte mit deinen Markern, Routen und Notizen. Kein Konto erforderlich.",
      ...
      "ui.HelpLineMarker2": "Wenn Sie das Feld Geteilt aktivieren, wird der Marker im Freigabelink enthalten sein",
      "ui.Notes": "Notizen",
  ...
  pt: {
    ...
    'ui.MergeRoutesButton': 'Adicionar compartilhado ao meu mapa',
     ...
     "character.CreateButton": "Criar",
      ...
      "share.tooltip": "Compartilhe seu mapa com seus marcadores, rotas e notas. Nenhuma conta é necessária.",
      ...
      "ui.HelpLineMarker2": "Se marcar Compartilhado, o marcador será incluído no link gerado",
      "ui.Notes": "Notas",
  ...
  ru: {
    ...
    "share.tooltip": "Поделитесь своей картой с вашими метками, маршрутами и заметками. Учетная запись не требуется.",
    ...
    "ui.HelpLineMarker2": "Если включить «Общий», маркер будет включён в ссылку",
    "ui.Notes": "Заметки",
    ...
    it: {
      ...
      "share.tooltip": "Condividi la tua mappa con i tuoi indicatori, percorsi e note. Nessun account richiesto.",
      ...
      "ui.HelpLineMarker2": "Se abiliti Condiviso, il segnalino sarà incluso nel link condiviso",
      "ui.Notes": "Note",
    ...
    zh: {
      ...
      'ui.ShowHideSharedMarker': '显示共享标记',
      ...
      "share.tooltip": "将你的地图连同标记、路线和备注一起分享。无需账户。",
      ...
      "ui.HelpLineMarker2": "若勾选“共享”，该标记将包含在共享链接中",
      "ui.Notes": "备注",
    ...
    ja: {
      ...
      "share.tooltip": "マーカー・ルート・メモ付きのマップを共有できます。アカウント登録は不要です。",
      ...
      "ui.HelpLineMarker2": "「共有」を有効にすると、共有リンクを生成した際に含まれます",
      "ui.Notes": "ノート",
