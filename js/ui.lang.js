...
(function () {
  ...
  const translations = {
    en: {
      ...
      "ui.Share": "Copy link",
      "ui.HelpLineShare1": "Click “Share my map” to generate a link containing your markers, routes, and notes",
    ...
    fr: {
     ...
     "ui.MergeRoutesButton": "Ajouter le partage à ma carte",
      ...
      "ui.HelpLineShare1": "Cliquez sur « Partager ma carte » pour générer un lien contenant vos marqueurs, tracés et notes",
    ...
    es: {
      ...
      "ui.HelpLineShare1": "Haz clic en « Compartir mi mapa » para generar un enlace que contiene tus marcadores, rutas y notas",
    ...
    de: {
      ...
      "ui.HelpLineShare1": "Klicke auf „Meine Karte teilen“, um einen Link mit deinen Markierungen, Routen und Notizen zu erstellen",
  ...
  pt: {
    ...
    "ui.MergeRoutesButton": "Adicionar compartilhado ao meu mapa",
     ...
     "character.CreateButton": "Criar",
      ...
      "ui.HelpLineShare1": "Clique em « Compartilhar meu mapa » para gerar um link contendo seus marcadores, rotas e notas",
  ...
  ru: {
    ...
    "ui.HelpLineShare1": "Нажмите «Поделиться картой», чтобы создать ссылку с вашими маркерами, маршрутами и заметками",
    ...
    it: {
      ...
      "ui.Share": "Copia link",
      "ui.HelpLineShare1": "Fai clic su « Condividi la mia mappa » per generare un link contenente i tuoi marcatori, percorsi e note", 
    ...
    pl: {
      ...
      "ui.HelpLineShare1": "Kliknij „Udostępnij moją mapę”, aby wygenerować link z trasami, znacznikami i notatkami",
      "ui.HelpLineShare2": "Wszystkie trasy i notatki są udostępniane, ale tylko znaczniki oznaczone jako „Udostępnione”",
      "ui.HelpLineShare3": "Podziel się swoją podróżą i notatkami zadań, aby wzbogacić mapę społeczności",
    ...
    zh: {
      ...
      "ui.Share": "复制链接",
      "ui.HelpLineShare1": "点击「分享我的地图」以生成一个包含你的标记、路线和笔记的链接",
    ...
    ja: {
      ...
      "ui.Share": "リンクをコピー",
      "ui.HelpLineShare1": "「マイマップを共有」をクリックすると、マーカー・ルート・メモを含むリンクが生成されます",
    ...
    ko: {
      ...
      "ui.Share": "링크 복사",
      "ui.HelpLineShare1": "“내 지도 공유”를 클릭하면 마커, 경로 및 메모가 포함된 링크가 생성됩니다",
      "ui.HelpLineShare2": "모든 경로와 메모는 공유되지만, “공유됨”으로 체크된 마커만 포함됩니다",
      "ui.HelpLineShare3": "여정과 퀘스트 메모를 공유하여 더 풍부한 커뮤니티 지도를 만들어 보세요.",
