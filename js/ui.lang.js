...
(function () {
  ...
  const translations = {
    en: {
      ...
      "share.tooltip": "Generates a unique link per character to share your complete map",
    ...
    fr: {
     ...
     "ui.MergeRoutesButton": "Ajouter le partage à ma carte",
      ...
      "share.tooltip": "Génère un lien unique par personnage pour partager votre carte complète",
    ...
    es: {
      ...
      "share.tooltip": "Genera un enlace único por personaje para compartir tu mapa completo",
    ...
    de: {
      ...
      "share.tooltip": "Erstellt einen eindeutigen Link pro Charakter, um deine vollständige Karte zu teilen",
  ...
  pt: {
    ...
    "ui.MergeRoutesButton": "Adicionar compartilhado ao meu mapa",
     ...
     "character.CreateButton": "Criar",
      ...
      "share.tooltip": "Gera um link único por personagem para compartilhar seu mapa completo",
  ...
  ru: {
    ...
    "share.tooltip": "Создаёт уникальную ссылку для каждого персонажа, чтобы поделиться полной картой",
    ...
    it: {
      ...
      "share.tooltip": "Genera un link univoco per personaggio per condividere la mappa completa",
    ...
    pl: {
      ...
      "share.tooltip": "Generuje unikalny link dla każdej postaci do udostępnienia całej mapy",
    ...
    zh: {
      ...
      "share.tooltip": "为每个角色生成一个唯一链接，用于分享完整地图",
    ...
    ja: {
      ...
      "share.tooltip": "キャラクターごとに一意のリンクを生成し、マップ全体を共有できます",
    ...
    ko: {
      ...
      "share.tooltip": "캐릭터별로 고유한 링크를 생성하여 전체 지도를 공유합니다",
