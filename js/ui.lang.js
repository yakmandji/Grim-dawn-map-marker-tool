...
(function () {
  ...
  const translations = {
    en: {
      ...
      "ui.NothingDone": "Nothing archived",
      ...
      "ui.HelpLineMarker2": "For each marker you create, you can edit it, delete it, get a shareable link, or move it to the completed panel",
      "ui.Notes": "Notes",
    ...
    fr: {
     ...
     "ui.MergeRoutesButton": "Ajouter le partage à ma carte",
      ...
      "ui.HelpLineMarker2": "Pour chaque marqueur créé, vous pouvez le modifier, le supprimer, obtenir un lien de partage ou le déplacer dans le panneau des éléments terminés",
      "ui.Notes": "Notes",
    ...
    es: {
      ...
      "ui.HelpLineMarker2": "Para cada marcador creado, puedes editarlo, eliminarlo, obtener un enlace para compartir o moverlo al panel de completados",
      "ui.Notes": "Notas",
    ...
    de: {
      ...
      "ui.HelpLineMarker2": "Für jeden erstellten Marker kannst du ihn bearbeiten, löschen, einen Freigabelink erhalten oder ihn in das Erledigt-Panel verschieben",
      "ui.Notes": "Notizen",
  ...
  pt: {
    ...
    "ui.MergeRoutesButton": "Adicionar compartilhado ao meu mapa",
     ...
     "character.CreateButton": "Criar",
      ...
      "ui.HelpLineMarker2": "Para cada marcador criado, você pode editá-lo, excluí-lo, obter um link de compartilhamento ou movê-lo para o painel de concluídos",
      "ui.Notes": "Notas",
  ...
  ru: {
    ...
    "ui.HelpLineMarker2": "Для каждого созданного маркера вы можете отредактировать его, удалить, получить ссылку для обмена или переместить в панель завершённых",
    "ui.Notes": "Заметки",
    ...
    it: {
      ...
      "ui.NothingDone": "Nessun archivio", 
      ...
      "ui.HelpLineMarker2": "Per ogni marcatore creato, puoi modificarlo, eliminarlo, ottenere un link di condivisione o spostarlo nel pannello dei completati",
      "ui.Notes": "Note",
    ...
    pl: {
      ...
      "character.DuplicateToggle": "Duplikuj istniejącą postać",
      "character.DuplicateSourceLabel": "Postać do skopiowania →",
      ...
      "ui.HelpLineMarker2": "Każdy znacznik można edytować, usunąć, udostępnić lub przenieść do panelu ukończonych",
      "ui.Notes": "Notatki",
    ...
    zh: {
      ...
      "ui.HelpLineMarker2": "对于每个创建的标记，你可以编辑、删除、获取分享链接，或将其移动到已完成面板",
      "ui.Notes": "备注",
    ...
    ja: {
      ...
      "ui.HelpLineMarker2": "作成した各マーカーは、編集・削除・共有リンクの取得、または完了パネルへの移動ができます",
      "ui.Notes": "ノート",
    ...
    ko: {
      ...
      "character.DuplicateToggle": "기존 캐릭터 복제",
      "character.DuplicateSourceLabel": "복제할 캐릭터 →",

      "ui.HelpLine1": "미니맵 아래의 드롭다운에서 지도(본편 또는 DLC)를 선택할 수 있습니다",
      "ui.Markers": "마커",
      "ui.HelpLineMarker1": "새 마커를 선택하고 카테고리를 지정한 후 이름을 입력하고 지도에 클릭하여 배치하세요",
      "ui.HelpLineMarker2": "생성한 각 마커는 편집, 삭제, 공유 링크 생성 또는 완료 패널로 이동할 수 있습니다",
      "ui.Notes": "메모",
