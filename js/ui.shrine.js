...
(function () {
  ...
  window.SHRINE_MARKERS_CAIRN = [
    { id: 'shrine_Burial_Hill', regionTag: 'tagMapBurialHill', xp: 70.09, yp: 83.85, difficulty: 'normal', isDungeon:true },
    { id: 'shrine_MapFoggy_Bank', regionTag: 'tagMapFoggyBank', xp: 64.93, yp: 74.96, difficulty: 'normal', isDungeon:true },
    { id: 'shrine_Devils_Crossing_Aquifer', regionTag: 'tagUGDevilsCrossingAquifer', xp: 72.14, yp: 90.65, difficulty: 'normal', isDungeon:true },
    { id: 'shrineMapFloodedPassage01', regionTag: 'tagMapFloodedPassage01', xp: 63.82, yp: 69.77, difficulty: 'normal', isDungeon: true },
    { id: 'shrineUGBurialCave', regionTag: 'tagUGBurialCave', xp: 63.37, yp: 67.20, difficulty: 'normal', isDungeon: true },
    ...
    { id: 'shrinetagUGOldArkovia02', regionTag: 'tagUGOldArkovia02', xp: 49.09, yp: 67.30, difficulty: 'normal', isDungeon:true },
    { id: 'shrinetagMapBarrenHighlands', regionTag: 'tagMapBarrenHighlands', xp: 43.05, yp: 81.97, difficulty: 'normal' },
    { id: 'shrinetagUGBrokenHills02B', regionTag: 'tagUGBrokenHills02B', xp: 50.91, yp: 94.66, difficulty: 'normal', isDungeon:true },
    { id: 'shrinetagMapMountainDeeps', regionTag: 'tagMapMountainDeeps', xp: 22.10, yp: 75.79, difficulty: 'normal', isDungeon:true },
    { id: 'shrinetagUGJaggedWasteCave02', regionTag: 'tagUGJaggedWasteCave02', xp: 37.03, yp: 82.31, difficulty: 'normal', isDungeon:true },
    ...
    { id: 'shrinetagUGHomesteadCave01', regionTag: 'tagUGHomesteadCave01', xp: 14.63, yp: 64.63, difficulty: 'normal', isDungeon:true },
    ...
    { id: 'shrinetagUGCryptNecropolis01', regionTag: 'tagUGCryptNecropolis01', xp: 33.48, yp: 9.95, difficulty: 'normal', isDungeon:true },
    { id: 'shrinetagUGCryptFinal01', regionTag: 'tagUGCryptFinal01', xp: 14.86, yp: -0.61, difficulty: 'normal', isDungeon:true },
  ...
  window.SHRINE_MARKERS_BY_SIZE = {
    ...
    '5500x6716': window.SHRINE_MARKERS_ASTERKARN,
  };
